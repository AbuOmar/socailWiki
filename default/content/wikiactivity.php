...
<div class="column_8 structure_only" id="post_output">
	<article>
		<header>
			...
			<? } ?>
					...
					<span class="content_meta" style="font-size:large;">
	...
	<aside id="post_tools">
				...
				<ul class="post_actions">
					<li><a href="<? $doc->write('permalink'); ?>" title="<? $doc->write('headline'); ?>">Permalink</a> </li>
					<li><a href="<? echo  str_replace('api', 'index', $wiki->get('api')); ?>?title=<?$doc->write('headline');?>&diff=0">View changes</a></li>
					...
					<? if ($doc->isEditable()) { ?>
						<li>
							<a href="<? $doc->write('editlink'); ?>" title="Edit this post" class="edit_button">Attach more information</a>
						</li>
					<? } ?>
				</ul>
			<? } ?>
